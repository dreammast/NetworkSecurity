...
from network_security.entity.artifiact_entity import DataTransformationArtifact,ModelTrainerArtifact
from network_security.entity.config_entity import ModelTrainerConfig
from network_security.utils.ml_utils.model.estimater import NetworkModel
from network_security.utils.main_utils.utils import save_object,load_object,evaluate_models
...
import dagshub
dagshub.init(repo_owner='dreammast', repo_name='NetworkSecurity', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        ...
        logging.info(f"model trainer artifact:{self.model_trainer_config}")
